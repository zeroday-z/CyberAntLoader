...
//DWORD get_process_id_and_thread_id_by_window_class(LPCSTR window_class_name, LPCSTR window_name, PDWORD p_thread_id)
//{
//	DWORD process_id = 0;
//	*p_thread_id = GetWindowThreadProcessId(FindWindow(window_class_name, NULL), &process_id);
//	return process_id;
//}
...
DWORD get_process_id_and_thread_id_by_window_class(LPCSTR window_class_name, LPCSTR window_name, PDWORD p_thread_id)
{
	...
	while (!process_id)
	{
		*p_thread_id = GetWindowThreadProcessId(FindWindow(window_class_name, window_name), &process_id); Sleep(20);
	} return process_id;
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
